...
(defconst matlab-mode-version "1.10.1 30May97"
...
;;; Change log
;;
;; 30May97 by Matt Wette <mwette@alumni.caltech.edu>
;;	C-up => (control up) fix thanks to Axel Hecht <ah@numerik.uni-kiel.de>
;;	Don't call auto-fill after run-hook. -- release as 1.10.1
;; 21May97 by Alf-Ivar Holm <alfh@ifi.uio.no>
;;	changed matlab-shell-describe-variable to matlab-shell-run-command;
;;	added matlab-shell-command-switches; changed binding of matlab-shell-
;;	last-error; fixed \C-c<letter> bindings in matlab-help-map; fix to
;;	matlab-shell-topic-browser-mode
;;
...
;;            word componant such as the symbol the_end
...
;;      Added Imenu keyworks.  Permits use w/ imenu and emacs/speedbar
